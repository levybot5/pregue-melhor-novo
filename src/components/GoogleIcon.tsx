// Marca oficial do Google (4 cores) — único jeito reconhecível de
// sinalizar "entrar com Google" nos botões de /entrar e /cadastrar,
// texto sozinho não passa confiança nesse tipo de botão.
export function GoogleIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
      ...
      <path
        fill="#EA4335"
        d="M12 4.75c1.76 0 3.34.6 4.58 1.79l3.44-3.44C17.95 1.19 15.24 0 12 0 7.31 0 3.25 2.7 1.27 6.62l4 3.11C6.22 6.87 8.87 4.75 12 4.75Z"
      />
    </svg>
  );
}
